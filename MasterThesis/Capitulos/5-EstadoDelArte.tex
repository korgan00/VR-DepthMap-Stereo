...
\begin{subfigure}{.5\linewidth}
	\centering
	\includegraphics[width=0.90\linewidth]{FB/fbnormalartifacts}
  \caption{Conferencia mostrando los artefactos que obtienen}
  \label{fig:fbnormalmapartifacts-example}
\end{subfigure}%
\begin{subfigure}{.5\linewidth}
	\centering
	\includegraphics[width=0.90\linewidth]{FB/fbnormalmap}
...
\begin{subfigure}{.5\linewidth}
	\centering
	\includegraphics[width=0.90\linewidth]{FB/fblighting}
  \caption{Conferencia mostrando la malla iluminada}
  \label{fig:fblighting-example}
\end{subfigure}%
\begin{subfigure}{.5\linewidth}
	\centering
	\includegraphics[width=0.90\linewidth]{FB/fbflooding}
